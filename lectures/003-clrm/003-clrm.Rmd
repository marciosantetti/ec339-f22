...
--
  ...
  - .b[Linear] means .b[linear in parameters] $(\beta_i)$;
  
  - .b[Correctly specified] means that it has the correct .b[functional form] and .b[no omitted variables].
...
One of the main reasons for a .b[violation] of CLRM Assumption I is an .b[incorrectly specified model].
...
<br>
  ...
  - It follows a .b[probability distribution] centered around zero.
...
From standard .b[Microeconomic theory], recall:

  - Factors that influence the .b[demand] for a given good:
  
  - Price, price of substitutes, preferences...
...
<br>
  ...
  - Occurs when the model's disturbances are .b[correlated over time], i.e., $Cor(u_t, u_j) \neq 0$ for $t \neq j$.
