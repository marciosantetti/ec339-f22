...
[^2]: As a quick historical note, in case you are curious to know more about the historical origin of the term "regression," make sure to check out the paper by J. Stanton listed on the "extra readings" module on `theSpring`.
